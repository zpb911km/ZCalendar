...
const convertCalendarFromBackend = (backendCalendar: any): Calendar => {
  return {
    ...backendCalendar,
    created_at:
      typeof backendCalendar.createdAt === 'string'
        ? new Date(backendCalendar.createdAt)
        : backendCalendar.createdAt,
    updated_at:
      typeof backendCalendar.updatedAt === 'string'
        ? new Date(backendCalendar.updatedAt)
        : backendCalendar.updatedAt,
  } as Calendar;
};
